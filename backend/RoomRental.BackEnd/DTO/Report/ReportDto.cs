namespace RoomRental.BackEnd.DTO.Report;
...
public class ReportDto
{
    ...
    [JsonIgnore] public int Status { get; set; } // 0: Pending, 1: Processing, 2: Resolved, 3: Rejected
...
public class UpdateReportStatusDto
{
    ...
    [JsonIgnore] public string? StatusName { get; set; }
    public string? TenTrangThai { get => StatusName; set => StatusName = value; }
